...
5. Commit multiple times within the branch while working:  
  ...
  `git commit -m "message"`  
6. After done working on branch, move to main: `git checkout main`  
7. When on main, push branch to GitHub: `git push`  
8. Wait for GitHub reviewer to accept your pull request into the **remote** main repo.  
9. All done! Repeat the cycle for your next task.  
